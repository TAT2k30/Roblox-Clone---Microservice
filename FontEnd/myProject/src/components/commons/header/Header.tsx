            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <nav className="space-x-8">
                        <a href="#" className="text-sm font-medium hover:text-gray-400">Charts</a>
                        <a href="#" className="text-sm font-medium hover:text-gray-400">Marketplace</a>
                        <a href="#" className="text-sm font-medium hover:text-gray-400">Create</a>
                        <a href="#" className="text-sm font-medium hover:text-gray-400">Robux</a>
                    </nav>
                </div>
